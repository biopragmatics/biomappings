...
You can get started by creating a file called ``biomappings_custom.py``. You can name
this file whatever you want, just make sure to update the names in the various parts of
the tutorial:
