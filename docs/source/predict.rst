...
The hard work is done by :func:`biomappings.lexical.append_lexical_predictions` when called
...
:func:`biomappings.lexical.append_lexical_predictions`. By modifying the previous example,
...
.. code-block:: python
    ...
    provenance = get_script_url(__file__)
    append_lexical_predictions("chebi", "mesh", provenance=provenance, path=PREDICTIONS_PATH)
