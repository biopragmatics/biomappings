...
class PredictionTuple(NamedTuple):
    ...
    they were generated using Gilda. Depending on the script, the score therefore refers to either:
    ...
    2. A high-level estimation of the precision of the scores generated by the given script.
       For example, the CL-MeSH mappings were estimated to be 90% correct, so all of the mappings
